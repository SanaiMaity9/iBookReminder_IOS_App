...
class CatalogeViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, UISearchBarDelegate, UISearchDisplayDelegate{
            ...
            case 1 :
                    ...
                    
                {
                    if  var results = objects {
                        ...
                        var match = results[res[i]] as! NSManagedObject
    ...
    @IBAction func Actionforaddbook(sender: AnyObject) {
        
        
        if self.bt1.backgroundColor == UIColor.whiteColor(){
            bt2.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
            bt3.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
            
        }else if self.bt2.backgroundColor == UIColor.whiteColor(){
            bt1.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
            bt3.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
        ...
        let deleteAction = UIAlertAction(title: "Add books manually", style: .Default, handler: {
            (alert: UIAlertAction!) -> Void in
            println("Add book manually")
            self.performSegueWithIdentifier("add", sender: self)
            
            
        })
        let saveAction = UIAlertAction(title: "Search books from web", style: .Default, handler: {
            (alert: UIAlertAction!) -> Void in
            println("Search by service")
