...
class PurchasedViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, UISearchBarDelegate, UISearchDisplayDelegate {
...
extension Array {
    func indexesOf1<T : Equatable>(object:T) -> [Int] {
        var result: [Int] = []
