...
//        v.layer.borderWidth = 2
    ...
    override func dismissalTransitionWillBegin() {
        ...
        let v = vc.view
        let con = self.containerView!
        let shadow: AnyObject = con.subviews[0]
        let tc = vc.transitionCoordinator()!
        tc.animateAlongsideTransition({
            _ in
            //shadow.alpha(CGFloat(0))
            }, completion: {
                _ in
    ...
    override func containerViewWillLayoutSubviews() {
        ...
        let v = self.presentedView()!
        v.autoresizingMask = UIViewAutoresizing.FlexibleTopMargin | UIViewAutoresizing.FlexibleBottomMargin | UIViewAutoresizing.FlexibleLeftMargin | UIViewAutoresizing.FlexibleRightMargin
